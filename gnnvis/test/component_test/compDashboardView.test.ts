...
import CompDashboardComp from "../../src/components/compDashboardView.vue";
import {
    Dataset,
    CompDashboard,
    View,
...
const props: InstanceType<typeof CompDashboardComp>["$props"] = {
    compDbId: "db0",
};
            ...
            compDashboardList: [
                {
                    ...
                    viewsDefinitionList: [
                        ...
                        {
                            viewName: "Topo + Latent Density - Model 1",
                            initialWidth: 500,
                            initialHeight: 541,
                            bodyHeight: 500,
                            bodyWidth: 500,
                        ...
                        {
                            viewName: "Topo + Latent Density - Model 2",
                            initialWidth: 500,
                            initialHeight: 541,
                            bodyHeight: 500,
                            bodyWidth: 500,
                        ...
                        {
                            viewName: "Prediction Space - Model 1",
                            initialWidth: 500,
                            initialHeight: 541,
                            bodyHeight: 500,
                            bodyWidth: 500,
                        ...
                        {
                            viewName: "Prediction Space - Model 2",
                            initialWidth: 500,
                            initialHeight: 541,
                            bodyHeight: 500,
                            bodyWidth: 500,
...
describe("test comp dashboard - node classification", () => {
    it("should render", () => {
        const mock = vi.fn(document.querySelector).mockImplementation(() => {
            const divElement = document.createElement("div");

            divElement.id = `comp-dashboard-${props.compDbId}`;
            return divElement;
        });
        ...
        const wrapper = mount(CompDashboardComp, {
            props: props,
            global: {
