...
import PolarRenderer from "../../../src/components/comparison/polarRenderer.vue";
import {
    CompDashboard,
    Dataset,
    PolarDatum,
...
const props: InstanceType<typeof PolarRenderer>["$props"] = {
    dbId: "db-test",
...
describe("test polar renderer", () => {
    it("test render", () => {
        const wrapper = mount(PolarRenderer, {
            props: props,
            global: {
                plugins: [testPinia],
            },
