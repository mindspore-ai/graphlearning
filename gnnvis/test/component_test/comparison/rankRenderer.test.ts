...
import RankRenderer from "../../../src/components/comparison/rankRenderer.vue";
import {
    CompDashboard,
    Dataset,
    RankDatum,
...
const props: InstanceType<typeof RankRenderer>["$props"] = {
    dbId: "db-test",
...
describe("test rank renderer", () => {
    it("test render", () => {
        const wrapper = mount(RankRenderer, {
            props: props,
            global: {
                plugins: [testPinia],
            },
