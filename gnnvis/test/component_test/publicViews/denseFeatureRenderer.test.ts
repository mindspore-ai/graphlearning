...
import DenseFeatureRenderer from "../../../src/components/publicViews/denseFeatureRenderer.vue";
import { Dataset, SingleDashboard, View } from "../../../src/types/types";

const props: InstanceType<typeof DenseFeatureRenderer>["$props"] = {
    dbId: "db-test",
...
describe("test dense feature renderer", () => {
    it("test render", () => {
        const wrapper = mount(DenseFeatureRenderer, {
            props: props,
            global: {
                plugins: [testPinia],
            },
