...
import GraphTsneHeader from "../../../src/components/publicViews/graphTsneHeader.vue";
import {
    AggregatedView,
    Dataset,
    LinkableView,
...
const props: InstanceType<typeof GraphTsneHeader>["$props"] = {
    dbId: "db-test",
...
describe("test graph tsne renderer", () => {
    it("test render", () => {
        ...
        const wrapper = mount(GraphTsneHeader, {
            props: props,
            global: {
