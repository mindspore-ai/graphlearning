...
import LinkPredHeader from "../../../src/components/publicViews/linkPredHeader.vue";
import {
    Dataset,
    LinkPredView,
    SingleDashboard,
...
const props: InstanceType<typeof LinkPredHeader>["$props"] = {
    dbId: "db-test",
...
describe("test link pred header", () => {
    it("test render", async () => {
        const myStore = useMyStore();
        expect(
            myStore.singleDashboardList[0].viewsDefinitionList[0].currentHops
        ).toBeUndefined();
        const wrapper = mount(LinkPredHeader, {
            props: props,
            global: {
