...
import MultiGraphRenderer from "../../../src/components/publicViews/multiGraphRenderer.vue";
import {
    Dataset,
    MultiGraphView,
    SingleDashboard,
...
const props: InstanceType<typeof MultiGraphRenderer>["$props"] = {
    dbId: "db-test",
...
describe("test multi graph renderer", () => {
    it("test render", () => {
        const wrapper = mount(MultiGraphRenderer, {
            props: props,
            global: {
                plugins: [testPinia, ElementPlus],
            },
        });
        const graphs = wrapper.findAll(".singleGraph");
