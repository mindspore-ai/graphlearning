...
import SparseFeatureRenderer from "../../../src/components/publicViews/sparseFeatureRenderer.vue";
import { Dataset, SingleDashboard, View } from "../../../src/types/types";

const props: InstanceType<typeof SparseFeatureRenderer>["$props"] = {
    dbId: "db-test",
...
describe("test sparse feature renderer", () => {
    it("test render", () => {
        const wrapper = mount(SparseFeatureRenderer, {
            props: props,
            global: {
        ...
        expect(bars.length).toBeCloseTo(2000, -1);
        //-1代表0.1的-1次方再除以二的上下阈值，即正负5
