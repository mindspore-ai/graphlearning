...
def main(arguments):
    ...
    train_dataloader = DataLoader(dataset=multi_graph_dataset, sampler=train_batch_sampler, num_workers=8,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', dest='dataset', default='EMZYMES', help='Input Dataset')
    parser.add_argument('--pool_ratio', dest='pool_ratio', default=0.10, type=float, help='pooling ratio')
    parser.add_argument('--num_pool', dest='num_pool', default=1, type=int, help='num_pooling layer')
    parser.add_argument('--link_pred', dest='linkpred', default=True, help='switch of link prediction object')
    parser.add_argument('--cuda', dest='cuda', default=0, type=int, help='switch cuda')
    ...
    parser.add_argument('--batch-size', dest='batch_size', default=20, type=int, help='batch size')
    parser.add_argument('--epochs', dest='epochs', default=4000, type=int, help='num-of-epoch')
    parser.add_argument('--train-ratio', dest='train_ratio', default=0.7, type=float,
                        help='ratio of trainning dataset split')
    parser.add_argument('--test-ratio', dest='test_ratio', default=0.1, type=float,
                        help='ratio of testing dataset split')
    parser.add_argument('--num_workers', dest='n_worker', default=1, type=int,
    ...
    parser.add_argument('--dropout', dest='dropout', default=1.0, type=float, help='dropout rate')
