...
def main(arguments):
    ...
    dataset = Alchemy(arguments.data_path)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--fuse', type=bool, default=False, help="use graph mode or pynative mode")
    parser.add_argument('--batch_size', type=int, default=16, help="batch size for graphs")
