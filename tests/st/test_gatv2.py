...
def test_gatv2():
    ...
    if not os.path.exists('./ci_temp'):
        os.mkdir('ci_temp')
    if os.path.exists('ci_temp/gatv2'):
        shutil.rmtree('ci_temp/gatv2')

    cmd_copy = "cp -r ../../model_zoo/gatv2/ ./ci_temp/"
    os.system(cmd_copy)

    cmd_train = "python ./ci_temp/gatv2/trainval_cora.py " \
                "--data_path=\"/home/workspace/mindspore_dataset/GNN_Dataset/\" >> ./ci_temp/gatv2/trainval_cora.log"
    os.system(cmd_train)

    file = open("./ci_temp/gatv2/trainval_cora.log", "r")
